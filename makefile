...
compilateur: cpyrr-lex cpyrr-yacc tlex.o tdec.o trep.o treg.o arbre.o global.o
	$(CC) lex.yy.c y.tab.c tlex.o tdec.o trep.o treg.o arbre.o global.o -o cpyrr.exe
